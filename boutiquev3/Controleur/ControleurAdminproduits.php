            ...
            if($fileError===0)
            {
                if($fileSize > 125000)
                {
                    ...
                    if(in_array($img_exe_str, $extension))
                    {
                        ...
                        $error['img'] = "<span>le type de fichier ne peut etre upload verifié uniquement jpg jpeg png webp ou svg</span>";
                    }
                }
            }
            if($fileError===4) {
            ...
            if($fileError===0)
            {
                ...
                if($fileSize > 900000) 
                {
                    ...
                    if(in_array($img_exe_str, $extension))
                    {
                        ...
                        $this->adminproduits->insertProduct($nom, $description, $prix, $img_name, $stock, $date_ajout, $id_categorie, $id_region);
