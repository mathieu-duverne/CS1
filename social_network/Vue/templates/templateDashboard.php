...
<head>
    ...
    <link href="./Style/css/dashboard/sidebars.css" rel="stylesheet">
</head>
<body>
...
<main>
    ...
    <div class="d-flex flex-column flex-shrink-0 bg-light" style="width: 4.5rem;">
        ...
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            ...
            <li>
                <a href="dashboardpost" class="nav-link py-3 border-bottom" title="Posts" data-bs-toggle="tooltip" data-bs-placement="right">
                    <svg class="bi" width="24" height="24"><use xlink:href="#grid"/></svg>
                </a>
            </li>
            <li>
                <a href="dashboarduser" class="nav-link py-3 border-bottom" title="Users" data-bs-toggle="tooltip" data-bs-placement="right">
        ...
        <div class="dropdown border-top">
            ...
            <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser3">
                <li><a class="dropdown-item" href="#"><other class="."></other></a></li>
...
<script src="./Style/js/dashboard/dashboard.js"></script>
<script src="./Style/js/dashboard/sidebars.js"></script>
</body>
</html>
